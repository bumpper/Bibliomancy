 ...
 * For Bibliomancy Tauri Application
 * 
...
function getPlatformConfig() {
    ...
    const configs = {
        win32: {
            ...
            installerPaths: [
                'msi\\Bibliomancy_1.0.0_x64_en-US.msi',
                'nsis\\Bibliomancy_1.0.0_x64-setup.exe'
            ]
        },
        darwin: {
            name: 'macOS',
            ...
            installerPaths: [
                'dmg/Bibliomancy_1.0.0_x64.dmg',
                'macos/Bibliomancy.app'
            ]
        },
        linux: {
            name: 'Linux',
            ...
            outputDir: 'src-tauri/target/release/bundle',
            installerPaths: [
                'deb/bibliomancy_1.0.0_amd64.deb',
                'appimage/bibliomancy_1.0.0_amd64.AppImage',
                'rpm/bibliomancy-1.0.0-1.x86_64.rpm'
            ]
        }
    };
